                    ...
                    <div class="single-item">
                        <div class="img-box">
                            ...
                            <div class="overlay">
                                <div class="inner">
                                    <div class="social">
                                        <a href="img/gallery/1.jpg" data-fancybox-group="example-gallery"
                    ...
                    <div class="single-item">
                        <div class="img-box">
                            ...
                            <div class="overlay">
                                <div class="inner">
                                    <div class="social">
                                        <a href="img/gallery/2.jpg" data-fancybox-group="example-gallery"
                                            class="view lightbox-image"><i class="flaticon-add"></i></a>
                                        <h4>title here</h4>
                                    </div>
                                </div>
                    ...
                    <div class="single-item">
                        <div class="img-box">
                            ...
                            <div class="overlay">
                                <div class="inner">
                                    <div class="social">
                                        <a href="img/gallery/3.jpg" data-fancybox-group="example-gallery"
                                            class="view lightbox-image"><i class="flaticon-add"></i></a>
                                        <h4>title here</h4>
                                    </div>
                                </div>
